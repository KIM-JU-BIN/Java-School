...
public class IfControlStatement {
	public static void main(String[] args) {
		...
		boolean bool2 = false;
		if(bool1) {
			System.out.println("실행3");//실행 됨
		}
		if(bool2) {
			System.out.println("실행4");//실행 안 됨
		}
		...
		if(value3>=90) {
			...
			System.out.println("B학점");//실행됨 => 실행 후 탈출
		}
		else if(value3>=70) {
		...
		if(value3>=70) {
			System.out.println("C학점");//실행 후 탈출함
		}
		else if(value3>=80) {
